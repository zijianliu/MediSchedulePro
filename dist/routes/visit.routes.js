...
router.post('/check-in/:id', auth_1.authMiddleware, visitController.checkIn);
router.post('/call', auth_1.authMiddleware, (0, auth_1.requireRoles)(enums_1.UserRole.DOCTOR), visitController.callNextPatient);
