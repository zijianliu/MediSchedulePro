...
export declare function listDepartments(req: Request, res: Response, next: any): Promise<void>;
export declare function getDepartment(req: Request, res: Response, next: any): Promise<void>;
